            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                {peymentStatus &&
                    <a
                        ...
                        className="col-span-1 md:col-span-12 flex items-center justify-between gap-4 glass-panel border border-[#5865F2]/50 shadow-[0_0_15px_rgba(88,101,242,0.2)] hover:shadow-[0_0_25px_rgba(88,101,242,0.6)] rounded-xl px-6 relative group hover:bg-[#5865F2]/10 transition-all duration-500 cursor-pointer overflow-hidden"
                    >
                        {/* Hacker Text Content */}
                        <div className="relative z-10 flex-1">
                            <h3 className="text-[#5865F2] flex items-center font-mono font-bold text-sm md:text-base tracking-wider drop-shadow-[0_0_5px_rgba(88,101,242,0.5)]">
                                {/* Added a solid block character to make the pulse more visible, adjust as needed */}
                                <span className="animate-pulse mr-2 opacity-80">█</span>
                                CONNECT_DISCORD_SERVER
                            </h3>
                        </div>

                        {/* Animated GIF - Acts as the icon on the right */}
                        <div className="relative z-10 shrink-0 opacity-50 group-hover:opacity-100 transition-all duration-500 group-hover:scale-110 drop-shadow-[0_0_10px_rgba(88,101,242,0.8)]">
                            <img
                                src="https://user-images.githubusercontent.com/74038190/235294015-47144047-25ab-417c-af1b-6746820a20ff.gif"
                                alt="Discord Matrix Logo"
            ...
            <div className="max-w-7xl mx-auto space-y-6 pt-6" hidden={!(userType === 'root')}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="glass-panel neon-border-green rounded-xl p-5 relative overflow-hidden group">
                        <div className="scan-line-anim opacity-10"></div>
                        <div className="flex justify-between items-start mb-2">
                            <span className="text-neon-green font-mono text-xs uppercase tracking-wider">Registerd Teams</span>
